      ...
      {track ? (
        <div className="flex-1 overflow-y-auto flex flex-col gap-3 sm:gap-4 pr-2">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div>
              <p className={`${headingTextSize} opacity-70 uppercase tracking-widest text-xs mb-2 font-bold`}>
                Now Playing
              </p>
              <h2 className={`${textSize} font-bold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent`}>
            ...
            <div className="pt-2 sm:pt-4">
              <p className={`${headingTextSize} opacity-70 uppercase tracking-widest text-xs mb-3 font-bold`}>
                Waveform
              </p>
        ...
        <div className="flex-1 flex items-center justify-center opacity-40">
          <div className="text-center">
            <HiMusicalNote size={36} className="mx-auto mb-2" />
