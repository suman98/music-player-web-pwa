  ...
  return (
    <div className={`glass ${padding} flex flex-col items-center gap-3 sm:gap-4 flex-shrink-0 rounded-3xl shadow-xl border border-white/10`}>
      ...
      <div className="text-center">
        <h2 className={`${titleSize} font-bold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent`}>
          {track ? truncateText(track.name, isMobile ? 20 : 30) : 'No track selected'}
        </h2>
        <p className="text-xs sm:text-sm opacity-70 mt-2 font-medium">
